...
CREATE TABLE IF NOT EXISTS `client_data`.`Child` (
  ...
  `Type_Of_Care` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `client_data`.`Target_Group` (
  ...
  `IRegulated_Profession` CHAR(1) NULL,
  `Regulated_Trade` CHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `client_data`.`Client_Enrolment` (
  `Course_Code` INT NOT NULL,
  `Client_Unique_ID_Value` VARCHAR(45) NOT NULL,
  `Date_First_Class` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `client_data`.`Info_and_Orientation` (
  ...
  `Overview_Of_Canada_R` CHAR(1) NULL,
  `Sources_Information` CHAR(1) NULL,
  `Sources_Information_R` CHAR(1) NULL,
  `Rights_Freedoms` CHAR(1) NULL,
  `Rights_Freedom_R` CHAR(1) NULL,
  `Canadian_Law_Justice` CHAR(1) NULL,
  `Canadian_Law_Justice_R` CHAR(1) NULL,
  `Important_Documents` CHAR(1) NULL,
  `Important_Document_R` CHAR(1) NULL,
  `Improving_Eng_Fr` CHAR(1) NULL,
  `Improving_Eng_Fr_R` CHAR(1) NULL,
  `Employment_Income` CHAR(1) NULL,
  `Employment_Income_R` CHAR(1) NULL,
  `Education` CHAR(1) NULL,
  `Education_R` CHAR(1) NULL,
  `Housing` CHAR(1) NULL,
  `Housing_R` CHAR(1) NULL,
  `Health` CHAR(1) NULL,
  `Health_R` CHAR(1) NULL,
  `Finance` CHAR(1) NULL,
  `Finance_R` CHAR(1) NULL,
  `Transportation` CHAR(1) NULL,
  `Transportation_R` CHAR(1) NULL,
  `Communications_Media` CHAR(1) NULL,
  `Communications_Media_R` CHAR(1) NULL,
  `Community_Engagement` CHAR(1) NULL,
  `Community_Engagement_R` CHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `client_data`.`Community_Connections` (
  ...
  `Volunteer_Participation` CHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `client_data`.`Find_Employment` (
  ...
  `Min_One_Year_Exp` CHAR(1) NULL,
  `NOC_Level_Intention` VARCHAR(45) NULL,
